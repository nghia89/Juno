    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        DefaultImage = c.String(maxLength: 256),
                        HoverImage = c.String(maxLength: 256),
                        DeatailImage = c.String(maxLength: 256),
                        ...
                        KieuDang = c.String(maxLength: 200),
                        ChatLieu = c.String(maxLength: 200),
                        MauSac = c.String(maxLength: 200),
                        KichCo = c.String(maxLength: 200),
                        DoCao = c.String(maxLength: 200),
                        BestWeek = c.Boolean(nullable: false),
                        NewBest = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        TitleNew = c.String(),
                        TitleImages = c.String(),
                        HTMLContent = c.String(),
                        Describe = c.String(),
                        NamePost = c.String(),
                        DatePost = c.DateTime(),
                        CategoryNewID = c.Long(),
                        DisplayOrder = c.Int(),
                        ShowHomePage = c.Boolean(),
                        Popular = c.Boolean(),
                        ViewBest = c.Boolean(),
                        Trash = c.Boolean(),
                        Update_by = c.String(maxLength: 200),
                        View = c.Int(),
                        Status = c.Boolean(),
                        LinkNews = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        provinceid = c.String(nullable: false, maxLength: 5),
        ...
        {
            DropForeignKey("dbo.Sizes", "PoductID", "dbo.Products");
            ...
            DropForeignKey("dbo.Picture", "ProductID", "dbo.Products");
